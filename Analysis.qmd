...
residual_vacc_uninf <- ggplot(data_uninfected_residuals, aes(x = vaccine, y = residuals)) +
  geom_boxplot() +
...
png("Q-Q Plot of Residuals for Uninfected Individuals_memory.png")
qqnorm(model_uninfected$residuals)
...
# Boxplot of residuals by vaccine
residual_vacc_inf <- ggplot(data_infected_residuals, aes(x = vaccine, y = residuals)) +
  geom_boxplot() +
  labs(y = "Residuals", x = "Vaccine") +
  scale_x_discrete(labels = toupper) +
  theme_cowplot_bg()
...
# Q-Q plot for the residuals of the beta regression model
png("Q-Q Plot of Residuals for Infected Individuals_memory.png")
qqnorm(model_infected$residuals)
