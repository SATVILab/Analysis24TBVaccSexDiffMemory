...
## Performing Simulataneous Hypothesis tests
...
null_model_infected <- betareg(prop_response ~ 1, data = data_tidy_vacc_summed|>
 dplyr::filter(infxn == "infected") )
summary(full_model_infected)

# Wald test
car::linearHypothesis(full_model_infected,
 c("vaccineh56 = 0", "vaccinemva85a = 0", "sexmale= 0", "vaccineh56:sexmale=0", "vaccinemva85a:sexmale= 0"))

# likelihood ratio test:
lmtest::lrtest(full_model_infected, null_model_infected)
```
...
null_model_uninfected <- betareg(prop_response ~ 1, data = data_tidy_vacc_summed|>
 dplyr::filter(infxn == "uninfected"))
summary(full_model_uninfected)

# Wald test
car::linearHypothesis(full_model_uninfected,
 c("vaccineh56 = 0", "vaccinemva85a = 0", "sexmale= 0", "vaccineh56:sexmale=0", "vaccinemva85a:sexmale= 0"))

# likelihood ratio test:
lmtest::lrtest(full_model_uninfected, null_model_uninfected)
```